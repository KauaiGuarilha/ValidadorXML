...
procedure TfrmNFe_Autorizada.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  FIDE_NFE_Doc.Free;
  FEMIT_NFE_Doc.Free;
...
procedure TfrmNFe_Autorizada.ide_nfe_doc;
...
procedure TfrmNFe_Autorizada.emit_nfe_doc;
...
procedure TfrmNFe_Autorizada.enderEmit_nfe_doc;
...
procedure TfrmNFe_Autorizada.dest_nfe_doc;
...
procedure TfrmNFe_Autorizada.enderDest_nfe_doc;
