...
procedure TfrmNFCe_Autorizado.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TfrmNFCe_Autorizado.ide_nfce_doc;
...
begin
  ...
  FIDE_NFCE_Doc.NodeIde := nodeInfNfe_ide;
  FIDE_NFCE_Doc.PreencherIDE;
...
procedure TfrmNFCe_Autorizado.emit_nfe_doc;
...
begin
  ...
  self.edtIEST.Text := FEMIT_NFE_Doc.TIEST; //Opcional
  self.edtCRT.Text := FEMIT_NFE_Doc.TCRT;
end;

procedure TfrmNFCe_Autorizado.enderEmit_nfe_doc;
...
procedure TfrmNFCe_Autorizado.dest_nfe_doc;
...
procedure TfrmNFCe_Autorizado.enderDest_nfe_doc;
...
begin
  ...
  self.edtDfone.Text := FENDERDEST_NFE_Doc.TDfone; //Opcional
end;
